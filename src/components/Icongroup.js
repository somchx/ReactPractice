    ...
    return (
        <div className="Header" id="Skill">
            <div className="container">
                <div className="Skill">
                    <div className="topic">
                        <h2><BiCodeBlock /> Skills & Tools</h2>
                    </div>
                    ...
                    <div className="Icon" data-aos="zoom-in">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/androidstudio/androidstudio-original.svg" alt="androidstudio" width="50" />
                    </div>
                    <div className="Icon" data-aos="zoom-in">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/arduino/arduino-original-wordmark.svg" alt="arduino" width="50" />
                    </div>
                    <div className="Icon" data-aos="zoom-in">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" alt="arduino" width="50" />
                    </div>
